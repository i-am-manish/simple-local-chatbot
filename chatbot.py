...
def assistant(command):
    ...
    #mail
        ...
        recipient = myCommand()
        if 'Divya' in recipient:
            JARVISResponse('What should I say to her?')
            content = myCommand()
    ...
    #change wallpaper
        ...
        urllib.urlretrieve(photo, "a") # Location where we download the image to.
    ...
    #askme anything
        ...
        try:
            if reg_ex:
                ...
                print(e)
                JARVISResponse(e)
                JARVISResponse('Hi User, I am JARVIS and I am your personal voice assistant, Please give a command or say "help me" and I will tell you what all I can do for you.')
